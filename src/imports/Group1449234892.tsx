import { imgVector29 } from "./svg-og8m1";
...
function Info() {
  return (
    <div className="absolute bg-[#007a55] h-[542px] left-[155px] overflow-clip rounded-[30px] top-9 w-[939px]" data-name="info">
      <SecondaryButtonM />
...
function Group1449234890() {
  return (
    <div className="absolute contents left-0 top-0">
      <Info />
      <div className="absolute h-[702px] left-0 top-0 w-[849px]">
        <div className="absolute inset-[-2.85%_-2.36%]">
          <img className="block max-w-none size-full" src={imgVector29} />
        </div>
      </div>
    </div>
  );
...
function Frame2087328690() {
  return (
    <div className="absolute h-[702px] left-0 top-0 w-[1094px]">
      <Group1449234891 />
    </div>
  );
}

function Frame2087328691() {
  return (
    <div className="absolute h-[702px] left-0 top-0 w-[1094px]">
      <Frame2087328690 />
    </div>
...
export default function Group1449234892() {
  return (
