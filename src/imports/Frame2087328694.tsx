...
import { imgEllipse } from "./svg-7nd5u";
...
function ChatGptImage1020251716181() {
  return (
    <div className="relative size-full" data-name="ChatGPT Image 10 сент. 2025 г., 17_16_18 1">
      ...
      <div className="absolute font-['Random_Grotesque_Standard_Semibold:StandardSemibold',_sans-serif] inset-[7.45%_71.48%_73.76%_0.38%] leading-[0.84] not-italic text-[0px] text-black tracking-[-0.24px]">
      ...
      <div className="absolute font-['Random_Grotesque_Standard_Semibold:StandardSemibold',_sans-serif] inset-[7.45%_33.4%_73.76%_38.46%] leading-[0] not-italic text-[0px] text-black tracking-[-0.24px]">
...
function Group1449234888() {
  return (
    <div className="absolute contents left-0 top-0">
      ...
      <div className="absolute bottom-[73.76%] font-['Random_Grotesque_Standard_Semibold:StandardSemibold',_sans-serif] leading-[0.84] left-[71.86%] not-italic right-0 text-[0px] text-black top-[7.45%] tracking-[-0.24px]">
